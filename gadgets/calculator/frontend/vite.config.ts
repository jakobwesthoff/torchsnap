...
const entries: Record<string, string> = {
  // Launcher entry is a barrel file that re-exports both
  // the view (`CalculatorView`) and inline view
  // (`CalculatorInline`) components — vite produces a
  // single `launcher.js` bundle with both named exports.
  launcher: resolve(__dirname, "src/launcher.tsx"),
  settings: resolve(__dirname, "src/settings/CalculatorSettings.tsx"),
};
