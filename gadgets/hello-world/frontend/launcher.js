...
//
// Minimal frontend component demonstrating the WASM gadget
...
//   1. torchsnap-gadget:// serves JS from the gadget source
 ...
 *
 * @param {object} props - GadgetViewProps from the host
...
export function Echo({ data, query, dismiss }) {
  ...
  return h("div", { className: "echo-view" },
    h("p", { className: "echo-label" }, "Hello from WASM gadget!"),
