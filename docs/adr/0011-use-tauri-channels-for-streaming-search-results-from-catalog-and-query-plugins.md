...
1. Receive `CatalogResults` first (sub-millisecond) and render
1. Receive `PluginResults` incrementally, interleave into the
   displayed list by score, re-render
1. Receive `Done` to finalize loading state
