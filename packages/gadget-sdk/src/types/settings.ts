...
// =========================================================
// Gadget Settings Hook Type
//
// Describes the signature of the `useGadgetSetting` hook
// that the host provides to each gadget's settings
// component. The hook is pre-bound to the gadget's namespace
// so calling `useGadgetSetting("greeting")` reads and writes
// `gadgets.<id>.greeting` in the global settings store.
//
